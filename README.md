<p align="center">
  <img src="https://raw.githubusercontent.com/Funora-Develop/.github/main/assets/funora-examples.svg" width="76" height="76" alt="">
</p>

<h1 align="center">Funora Examples</h1>

<p align="center"><em>Сквозные примеры, которые реально прогоняет CI.</em></p>
...
Минимальный клиент, автоответчик в личных сообщениях, слушатель событий заказа, монитор цены и остатка, синхронизация инвентаря, собственные middleware и хранилище. Примеры выполняются против mock в CI, чтобы документация не гнила незаметно.
