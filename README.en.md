...
<p align="center"><em>End-to-end examples that CI actually runs.</em></p>
...
Minimal client, private chat responder, order event listener, price and stock monitor, inventory sync, custom middleware and storage. Examples run against the mock in CI so the documentation cannot rot quietly.
